...
public class BaseWebAct extends AppCompatActivity {

    private static final String WEB_RUL = "https://www.baidu.com";
    private WebView webView;
    private ProgressBar progressBar;
    private String webData;//动态拼接的html内容
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webData = getIntent().getStringExtra(JumpUtil.BUNDLE);
        initWebView();
    }
    ...
    private void initWebView() {
        ...
        setting.setDomStorageEnabled(true);//在返回前一个页面的时候不刷新
